...
//---Medium
//create a function that takes in four numbers. Add the first two numbers and return the
// remainder of dividing the sum of the first two numbers by the difference of the last two numbers
